...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP  203.85
  #define DEFAULT_BED_KI   36.32
  #define DEFAULT_BED_KD  762.67
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 409.14 }
...
#define Y_MIN_POS -27
#define Z_MIN_POS 0
#define X_MAX_POS (X_MIN_POS + X_BED_SIZE) // = 230
#define Y_MAX_POS (Y_MIN_POS + Y_BED_SIZE) // = 190
