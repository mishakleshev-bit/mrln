...
// Включаем наш улучшенный алгоритм Pressure Advance
#define SIMPLIFIED_PA

// Опционально: Look-ahead через очередь блоков (требует больше RAM)
#define PA_LOOKAHEAD

// Максимальная коррекция давления в мм (защита от переполнения)
#define PA_MAX_P_MM 2.0f

// Время релаксации τ в миллисекундах (20мс для Direct Drive)
#define PA_TIME_CONST_MS 20.0f

// Минимальная длина блока в мм для применения Look-ahead
// Микро-сегменты (<0.5мм) игнорируются для стабильности
#define PA_MIN_BLOCK_MM 0.5f
