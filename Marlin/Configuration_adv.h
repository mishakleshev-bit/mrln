...
// Подробнее: docs/SPA_Documentation.md
  ...
  #define PA_LOOKAHEAD                      // Включает основной алгоритм в calc_traj_point() и поля block_t
    ...
    // что ведёт к рывкам экструдера и step loss.
    #define SPA_EMA_ALPHA          0.15f     // α = коэффициент EMA (0.0 = выкл)

    // ──────────────────────────────────────────────────────────────────────────
    // Task 2: Мягкое клиппирование (Soft Saturation / Anti-Windup) — НЕ АКТУАЛЬНО в v4.6+
    // ──────────────────────────────────────────────────────────────────────────
    // С переходом на offset = K × Ve_smooth (прямая пропорция, v4.6) windup интегратора устранён.
    ...
    // M900 E<alpha>   — SPA_EMA_ALPHA (0.0–1.0)
    // ──────────────────────────────────────────────────────────────────────────
