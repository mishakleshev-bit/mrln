...
//===========================================================================
//==================== SIMPLIFIED PRESSURE ADVANCE (SPA) v4.7 ===============
//===========================================================================
// SPA — Simplified Pressure Advance для Marlin FT Motion
// Пропорциональная модель offset = K × Ve (эквивалент Klipper PA).
//
// Для активации необходимы ОБА макроса: SIMPLIFIED_PA и PA_LOOKAHEAD.
//
// v4.7: EMA-фильтр удалён — FT Motion на 5 кГц генерирует гладкую траекторию,
//        дополнительное сглаживание вносило фазовую задержку ~1.13 мс.
//        offset = K × Ve_raw (без EMA, нулевая фазовая задержка).
